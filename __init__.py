...
def myfunc(clayout: CardLayout) -> None:
    # editor = clayout.tform.edit_area
    # showInfo(editor.document())
    # clayout.tform.edit_area = QtWidgets.QTextEdit("test")
    ...
    highlighter_widget = html.HtmlHighlighter(editor.document(), profiles['html']['style'])
    mw.my_widgets.append(highlighter_widget)
    return


gui_hooks.card_layout_will_show.append(myfunc)
